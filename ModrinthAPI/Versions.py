...
def get_multiple(version_ids: list):
    ...
    # params
    params = {
        'user_ids': json.dumps(version_ids)
    }

    # make request
    response, status_code = request(api_multiple_versions_url, params=params, method='GET')
...
def edit_version(version_id: str,
                 name: str,
                 version_number: str,
                 changelog: str,
                 dependencies: list,
